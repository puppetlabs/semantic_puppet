...
describe Semantic::VersionRange do
  ...
  describe '.parse' do
    ...
    context 'disjoint expressions' do
      expressions = {
        [ '1.2||1.2.4', '1.2 || 1.2.4' ] => {
          :to_str   => '1.2.x',
          :includes => [ '1.2.0-0', '1.2.999' ],
        ...
        [ '1.2||1.4', '1.2 || 1.4' ] => {
          :to_str   => '1.2.x || 1.4.x',
          :includes => [ '1.2.0-0', '1.2.999', '1.4.0-0', '1.4.999' ],
          :excludes => [ '1.1.999', '1.3.0-0', '1.3.999', '1.5.0-0' ],
        },
        [ '1.2||1.3', '1.2 || 1.3' ] => {
          :to_str   => '>=1.2.0 <1.4.0',
          :includes => [ '1.2.0-0', '1.2.999', '1.3.0-0', '1.3.999' ],
          :excludes => [ '1.1.999', '1.4.0-0' ],
        },
        [ '(1.1||1.3)||1.2', '(1.1 || 1.3) || 1.2' ] => {
          :to_str   => '>=1.1.0 <1.4.0',
          :includes => [ '1.1.0-0', '1.2.0', '1.3.0-0', '1.3.999' ],
          :excludes => [ '1.0.999', '1.4.0-0' ],
        },
        [ '1.5 || 1.3 || 1.1' ] => {
          :to_str   => '1.1.x || 1.3.x || 1.5.x',
          :includes => [
            '1.1.0-0', '1.1.999',
            '1.3.0-0', '1.3.999',
            '1.5.0-0', '1.5.999',
    ...
    context 'grouped expressions' do
      expressions = {
        ...
        [ '(1.2 || 1.4) >=1.2.3', '(1.2 >=1.2.3) || 1.4' ] => {
          :to_str   => '(>=1.2.3 <1.3.0) || 1.4.x',
          :includes => [
            '1.2.3-0', '1.2.999',
            '1.4.0-0', '1.4.999',
          ],
        ...
        [ '(1.2 || 1.4) <1.4.3', '1.2 || (1.4 <1.4.3)' ] => {
          :to_str   => '1.2.x || (>=1.4.0 <1.4.3)',
          :includes => [
            '1.2.0-0', '1.2.999',
            '1.4.0-0', '1.4.2-999',
          ],
        ...
        [
          ...
          :to_str   => '(>=1.2.3 <1.3.0) || (>=1.4.0 <1.4.3)',
          :includes => [
            '1.2.3-0', '1.2.999',
            '1.4.0-0', '1.4.2-999',
          ],
        ...
        [ '1.0 || (1.2 || 1.4) || 1.6', '1.0 || 1.2 || 1.4 || 1.6' ] => {
          :to_str   => '1.0.x || 1.2.x || 1.4.x || 1.6.x',
          :includes => [
            '1.0.0-0', '1.0.999',
            '1.2.0-0', '1.2.999',
            '1.4.0-0', '1.4.999',
        ...
        [ '(1.1 || 1.2 || 1.3) 1.2', '1.2 (1.1 || 1.2 || 1.3)' ] => {
          :to_str   => '1.2.x',
          :includes => [ '1.2.0-0', '1.2.999' ],
          :excludes => [ '1.1.999', '1.3.0-0' ],
        },
        [ '(1.0 || 1.2 || 1.4) 1.2', '1.2 (1.0 || 1.2 || 1.4)' ] => {
          :to_str   => '1.2.x',
          :includes => [ '1.2.0-0', '1.2.999' ],
          :excludes => [ '1.1.999', '1.3.0-0' ],
        },
